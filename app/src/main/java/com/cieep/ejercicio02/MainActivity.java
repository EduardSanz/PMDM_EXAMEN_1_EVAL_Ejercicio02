...
import com.cieep.ejercicio02.adapters.ContactosAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<ContactoMatricula> contactosMatricula;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactosMatricula = new ArrayList<>();
        adapter = new ContactosAdapter(contactosMatricula, R.layout.contacto_view_holder, this);
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == RESULT_OK) {
                            if (result.getData().getExtras() != null) {
                                ...
                                contactosMatricula.add(cm);
                                adapter.notifyItemInserted(contactosMatricula.size()-1);
                            }
                        }
                    }
                }
